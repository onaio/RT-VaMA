...
-- Within the RT-VaMA database, there are 4 schemas created using the sql queries below. For more information on schemas take a look at this guide (https://www.postgresql.org/docs/current/ddl-schemas.html)
