...
unnest(array['microplan','microplan','microplan','microplan','microplan','microplan','microplan','microplan','microplan','logistics_supply','logistics_supply','logistics_supply','logistics_supply','logistics_supply','logistics_supply','logistics_supply','social_mobilization','social_mobilization','social_mobilization','immunization_safety','immunization_safety','supervision','supervision','supervision','supervision','supervision','reporting_system','reporting_system','reporting_system','vaccine_management','vaccine_management','vaccine_management','vaccine_management','human_resource','human_resource']) as indicators_category
